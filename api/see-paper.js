  ...
  try {
    ...
    const groupEntries = Object.entries(groups)
      ...
      .map(([num, g]) => ({
        ...
        parent: g.parent ? {
          ...
          section:             g.parent.section               || '',   // 'A' | 'B' | 'C'
          diagram:             g.parent.diagram_svg           || null,
          steps:               g.parent.steps_en              || null,
          opts:                g.parent.opts_en               || null,
          correct:             g.parent.correct_opt           ?? null,
          // Optional enrichment fields — add DB columns when ready
          marking_scheme:      g.parent.marking_scheme        || null,
          why_examiner:        g.parent.why_examiner          || null,
          common_mistake:      g.parent.common_mistake        || null,
          simpler_explanation: g.parent.simpler_explanation   || null,
          similar_topic:       g.parent.similar_topic         || null,
        ...
        subs: g.subs.map(s => ({
          ...
          why_examiner:        s.why_examiner          || null,
          common_mistake:      s.common_mistake        || null,
          simpler_explanation: s.simpler_explanation   || null,
          similar_topic:       s.similar_topic         || null,
    ...
    return res.status(200).json({
      paper: {
        ...
        duration: papers[0].duration || '3 hours',
      },
      subject: {
